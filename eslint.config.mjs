...
export default tseslint.config(
    // Bỏ qua các thư mục build và môi trường
    {
        ignores: ['dist', 'build', 'coverage', '*.js', '*.cjs'], // nếu dự án có file JS thuần, thêm vào sau
    },

    // Cấu hình cơ bản từ ESLint cho JS
    eslint.configs.recommended,

    // Cấu hình TypeScript: dùng bộ "type-checked" (có kiểm tra type)
    ...tseslint.configs.recommendedTypeChecked,

    // Plugin: dùng Prettier để xử lý format → tránh rule style của ESLint
    prettierRecommended,
