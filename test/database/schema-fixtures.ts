...
export const schemaInventory: SchemaTableFixture[] = [
    ...
    },
    {
        ...
        columns: [
            ...
            decimal('discount_percent', 15, 2, true, '0'),
    ...
    },
    {
        ...
        columns: [
            ...
            varchar('full_name', 100, true),
            varchar('phone', 20, true),
            varchar('status', 20, true, "'PENDING'"),
            decimal('subtotal'),
            decimal('shipping_fee'),
            decimal('discount_amount', undefined, undefined, true, '0'),
            decimal('total_amount'),
            varchar('currency', 20, true, "'VND'"),
    ...
    },
    {
        ...
        columns: [
            ...
            varchar('applies_to', 20, true, "'ALL'"),
            timestamp('created_at', true, 'CURRENT_TIMESTAMP'),
            timestamp('updated_at', false, undefined, 3),
            timestamp('deleted_at', true),
        ],
